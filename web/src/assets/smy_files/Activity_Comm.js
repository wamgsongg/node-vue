...
//��ʽ������Ϊ9,999,999�ĸ�ʽ
function FormateNum(num) { //ת��Ϊǧ��λ  
    //1.��ȥ���ո�,�ж��Ƿ��ֵ�ͷ���   
    num = num + "";
...
function GetPageurl() {
    var url = window.location.href; //��ȡ����URL��ַ
    var tmp = ''; //��ʱ���������ڱ���ָ��ַ���
    tmp = url.split("/"); //����"/"�ָ�
    var cc = tmp[tmp.length - 1]; //��ȡ���һ���֣����ļ����Ͳ���
    tmp = cc.split("?"); //�Ѳ������ļ����ָ
    return tmp[0].split(".")[0]; //����ֵ
}
...
var registerCoralEvent = {
    ...
    //site1:'film',
    //site2:'client',
    //code: 0, // 1.ҳ��Ϊgbk 0Ϊutf-8
    //source: 9,  // ��ͬƽ̨��Ҫ����˲���

    //subsource:9.1,
    //listHiden: 0, // ����ʾ���ۣ�ֻ��ʾ���ۿ� - ��������  1Ϊ����ʾ 0Ϊ��ʾ
    //ownStyle: 'http://lol.qq.com/m/act/a20150930live/css/live.css',  // ˽����ʽ�ɸ�д������ʽ // **���Ƽ�
    //commentNums:2, // ����Ĭ����ʾ����������Ĭ��ֵ 10�� ���п�����ʾ�����������õ��٣�����Ϊ�����������δͨ��������ʾ����0�ǳ��׹ر�
    //commentHotNums:3 , // ��������
    //commentLink: 0,  // 0 �ǲ���Ҫ����

    //commentPost: 0,  // 0 ����ת
    //commentHot:0, // Ĭ�����ö����ۣ��������Ϊ 0 ȡ���ö�����
    //popupInfo:0,  // ��ͷ�񵯸��� 1:������0���ر�
    //popupLink:0,  // ��ͷ�ö�����ť���� 1:������0���ر�
    //reportBtn:0,  // �ٱ����ܣ�1,������ 0���ر�
    ...
    loginEvent: function () {
        ...
        //document.getElementById('onekey').onclick(); // ע���½�¼� ----��Ҫ�޸�
    },
